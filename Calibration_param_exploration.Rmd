...
melted_results2$type <- word(melted_results2$param, sep ="_")
melted_results2$type[!melted_results2$type%in%c("mum", "BHalpha", "KDENR")]<- "mQ"
melted_results2<- melted_results2[melted_results2$variable=="2025-02-04",]

par(mfrow = c(2,2))
x <- melted_results2$relative_chgmt[melted_results2$type == "KDENR"]

hist(x, breaks = 10, , xaxt = "n",
     main = "KDENR Calibration Factors",
...
hist(x, breaks = 10, , xaxt = "n",
     main = "BHalpha Calibration Factors",
     xlab = "Calibration Factor", ylab = "Frequency", 
     col = "grey80", border = "white")
