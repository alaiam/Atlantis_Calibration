...
sum(unlist(partial.fitness))/dt.timeserie
print("Total fitness for biomass indicator is:")
sum(unlist(partial.fitness$biomass))/dt.timeserie
print("Total fitness for Waa indicator is:")
sum(unlist(partial.fitness$waa))/dt.timeserie
print("Average Fitness for each biomass indicator is:")
(sum(unlist(partial.fitness$biomass))/dt.timeserie/74)
print("Average Fitness for each biomass indicator is:")
(sum(unlist(partial.fitness$waa))/dt.timeserie/(377))
```
