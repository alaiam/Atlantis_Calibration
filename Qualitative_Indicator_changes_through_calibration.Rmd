...
Test_long$PlotGroup <- ifelse(Test_long$Species %in% c("Undersized", "Oversized"), "B. Size indicators", "A. Biomass indicators")

# Couleurs améliorées
colors <- c("Collapse" = "#E41A1C", "Explosion" = "#377EB8", 
            "Undersized" = "#FF7F00", "Oversized" = "#4DAF4A")
# Création du plot avec espacement amélioré
ggplot(Test_long, aes(x = RUN, y = Value, color = Species, group = Species)) +
  ...
  theme(legend.title = element_blank(),
        ...
        panel.spacing = unit(1.5, "lines")) +  # Augmente l'espace entre les facettes
